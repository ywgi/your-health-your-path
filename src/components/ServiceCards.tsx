const ServiceCard: React.FC = () => {
    return (
        <div className="flex flex-col space-y-12">
            <div id="consult" className="bg-gradient-to-br from-white to-gray-50 p-6 rounded-xl shadow-md 
                ...
                <div className="relative">
                    <h3 className="text-2xl font-semibold font-heading text-light-teal-custom mb-3">Consultation</h3>
                    <p className="text-gray-600 text-md mb-2">Duration: 20 minutes</p>
                    <p className="text-coral-custom text-md mb-4">FREE</p>
                    <p className="text-gray-600 mb-4 leading-relaxed">
                        Personalized one-on-one consultation to discuss your health goals 
                        and what Ayurveda can do for you.
                    </p>
