...
import WalkYourPath from "../components/WalkYourPath";
import { Suspense, lazy } from "react";
import { useInView } from "../hooks/useInView"; // See hook code below

const LazyTestimonialsSlider = lazy(() => import("../components/Testimonials"));

const LazyTestimonialsWrapper = () => {
  const { ref, inView } = useInView<HTMLDivElement>();

  return (
    <div ref={ref} className="flex justify-center w-full min-h-[300px]">
      {inView && (
                        ...
                        <div className="w-full max-w-2xl mx-auto md:mx-0 px-4 mb-8 md:mb-16 lg:mb-0">
                            <div className="relative aspect-[4/3] w-full">
                                ...
                                <div className="relative w-4/5 sm:w-3/4 z-10">
                                    <img 
                                        loading="lazy"
                                        className="w-full border-8 md:border-4 lg:border-8 border-coral-custom object-cover animate-[fade-in_1s_ease-out]" 
                ...
                <section className="w-full">
                    <div className="flex flex-col md:flex-row lg:flex-row justify-center items-center w-full gap-6 lg:gap-8 bg-white">
                        ...
                        <div className="flex w-full lg:max-w-[40vw] justify-center flex-col text-left px-4 lg:p-4 order-2 md:order-1 lg:order-1">
                            ...
                            <p className="pl-0 lg:pl-4 text-lg lg:text-xl leading-tight mt-4">
                                Enthusiasm and curiosity filled me:
                            </p>
