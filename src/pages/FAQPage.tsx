...
import FAQEnglish from "../components/FAQEnglish";
            ...
            <div className="flex flex-col items-center justify-center md:px-8 lg:px-16 md:pb-8">
                ...
                <div className="flex flex-col lg:flex-row py-8 gap-8 lg:gap-20 w-full max-w-7xl">
                    ...
                    <div className="flex w-full lg:w-1/2 justify-center flex-col text-left px-4 lg:px-0 text-lg sm:text-xl animate-[fade-in_1s_ease-out] [animation-fill-mode:forwards]">
                        <h1 className="text-3xl sm:text-4xl font-bold font-heading tracking-wide text-light-teal-custom">More Questions?</h1>
                        <br/>
                        <h2 className="text-2xl sm:text-3xl font-heading tracking-wider text-dark-coral-custom">Get in Touch.</h2>
                        <br/>
                        <p className="text-lg sm:text-xl">
                            I am happy to help. You can call, WhatsApp or email and I will be happy to answer your questions as you navigate your way towards your (health) goals.
                        </p>
